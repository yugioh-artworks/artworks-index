...
const redrawControlled = (() =>
{
    ...
    let code = ("const manifest = await (await fetch('https://artworks.ygoresources.com/manifest.json')).json();\nconst cardData = manifest.cards["+selectedCardId+"]; // "+selectedCardName+"\nconsole.log(cardData);\n\n");
    ...
    code += "const artworkURL = new URL(artworkPath, 'https://artworks.ygoresources.com/');\ndocument.getElementById('artwork').src = artworkURL.href;";
